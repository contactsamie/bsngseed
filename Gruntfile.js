...
module.exports = function (grunt) {
 ...
 test: {
	...
	usemin: {
	  ...
	  css: ['<%= yeoman.dist %>/styles/**/*.css', '<%= yeoman.dist %>/templates/**/*.css', '<%= yeoman.dist %>/lib/**/*.css'],
	  options: {
		  assetsDirs: ['<%= yeoman.dist %>', '<%= yeoman.dist %>/images', '<%= yeoman.dist %>/templates', '<%= yeoman.dist %>/lib', '<%= yeoman.dist %>/templates/**', '<%= yeoman.dist %>/lib/**']
	  }
	},
	...
	imagemin: {
	  dist: {
		files: [{
		  expand: true,
		  cwd: ['<%= yeoman.app %>/images', '<%= yeoman.app %>/templates', '<%= yeoman.app %>/lib'],
